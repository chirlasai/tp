...
/**
 * Deletes a cat identified using it's displayed index from the address book.
 */
public class DeleteCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Deletes the cat identified by the index number used in the displayed cat list.\n"
